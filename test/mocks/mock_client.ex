defmodule HttpClient.MockClient do
  ...
  def get(_, "/vapid/companies/1/managed_equipment_types", _) do
    %ResponseResult{status_code: 200, parsed_body: [], reply: :ok}
  end

  def get(_, "/vapid/companies/1/managed_equipment_types/1", _) do
    %ResponseResult{status_code: 200, parsed_body: [], reply: :ok}
  end

  def get(_, "/vapid/companies/1/managed_equipment_models", _) do
    %ResponseResult{status_code: 200, parsed_body: [], reply: :ok}
  end

  def get(_, "/vapid/companies/1/managed_equipment_models/1", _) do
    %ResponseResult{status_code: 200, parsed_body: [], reply: :ok}
  end

  def get(_, "/vapid/companies/1/managed_equipment", _) do
    %ResponseResult{status_code: 200, parsed_body: [], reply: :ok}
  end

  def get(_, "/vapid/companies/1/managed_equipment/1", _) do
    %ResponseResult{status_code: 200, parsed_body: [], reply: :ok}
  end
  ...
  def post(_, "/vapid/companies/1/managed_equipment_types", _, _) do
    %ResponseResult{status_code: 201, parsed_body: %{}, reply: :ok}
  end

  def post(_, "/vapid/companies/1/managed_equipment_models", _, _) do
    %ResponseResult{status_code: 201, parsed_body: %{}, reply: :ok}
  end

  def post(_, "/vapid/companies/1/managed_equipment", _, _) do
    %ResponseResult{status_code: 201, parsed_body: %{}, reply: :ok}
  end
  ...
  def patch(_, "/vapid/companies/1/managed_equipment_types/1", _) do
    %ResponseResult{status_code: 200, parsed_body: %{}, reply: :ok}
  end

  def patch(_, "/vapid/companies/1/managed_equipment_models/1", _) do
    %ResponseResult{status_code: 200, parsed_body: %{}, reply: :ok}
  end

  def patch(_, "/vapid/companies/1/managed_equipment/1", _) do
    %ResponseResult{status_code: 200, parsed_body: %{}, reply: :ok}
  end
